 ...
 *
 * Return: the height of the tree. If tree is NULL, return zero
 */
 ...
 * @func: function supposed to be performed
 *
 * Return: void
 */
 ...
 * @func: pointer to a function to call for each node in the program.
